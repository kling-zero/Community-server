...
bool getStartArg(int argc, char* argv[]) {
	...
	std::string dbPassword = "abc123";
	int dbPort = 3306;
	std::string dbName = "zosc_tt";	std::string dbHost = "49.235.68.71";
	int dbMax = 25;
#ifdef USE_NACOS
	// Nacos配置参数
	std::string nacosAddr = "43.153.170.95:8848";

	std::string nacosNs = "47c1c93a-c48b-40e9-a474-6134ea4cbf75";
	std::string serviceName = "Property-Manage";
	std::string regIp = "43.142.178.47";
#endif
